...
\textbf{National University of Singapore - 2nd Year} \hfill Aug 2019 - May 2023
...
\begin{itemize}
    ...
    \item Teaching CS1101S (Programming Methodlogy) to freshmen
...
\begin{itemize}
    ...
    \item Implemented chat flow for automating unsold listings to free items using Golang and gRPC
    \item Benchmarked potential Golang libraries regarding Multi Pattern String Matching
    \item Developed REST APIs for automating querying of logs using Django
